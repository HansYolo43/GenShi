...
public class MainMenuUseCaseFactory {
    public static MainMenuView create(ViewManagerModel viewManagerModel, MainMenuViewModel mainMenuViewModel, GalleryViewModel galleryViewModel,  LoginViewModel loginViewModel, GamblingViewModel gamblingViewModel, GenerateCardViewModel generateCardViewModel) {
        MainMenuController mainMenuController = createMainMenuUseCase(viewManagerModel, mainMenuViewModel, galleryViewModel, loginViewModel, gamblingViewModel, generateCardViewModel);
        return new MainMenuView(mainMenuViewModel, mainMenuController);
    }

    private static MainMenuController createMainMenuUseCase(ViewManagerModel viewManagerModel, MainMenuViewModel mainMenuViewModel, GalleryViewModel galleryViewModel, LoginViewModel loginViewModel, GamblingViewModel gamblingViewModel, GenerateCardViewModel generateCardViewModel) {
